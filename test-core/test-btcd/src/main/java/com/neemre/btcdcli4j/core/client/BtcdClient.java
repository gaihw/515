...
public interface BtcdClient {
	...
	BigDecimal estimateFee() throws BitcoindException, CommunicationException;

	BigDecimal estimateSmartFee() throws BitcoindException, CommunicationException ;

	BigDecimal estimateFeeNoBlock() throws BitcoindException, CommunicationException;
	...
	BlockData getBlockData(String headerHash) throws BitcoindException, CommunicationException;
	...
	int generateToAddress(int count,String address) throws BitcoindException, CommunicationException;
	...
	RawTransactionOverview getRawTransactionV(String txId) throws BitcoindException, CommunicationException;
	...
	TxOut getTxOut(String var1, int var2) throws BitcoindException, CommunicationException;
	...
	SignatureResult signRawTransactionWithKey(String hexTransaction, List<Output> outputs, List<String> privateKeys)
			throws BitcoindException, CommunicationException ;
