...
public class BlockData extends Entity {
	...
	private List<RawTransactionOverview> tx;
	private Long time;
	private String bits;
	...
	public BlockData(String hash, Integer confirmations, Integer size, Integer height, Integer version,
                     String merkleRoot, List<RawTransactionOverview> tx, Long time, String bits,
