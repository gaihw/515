...
public enum Commands {
	...
	GENERATE_TO_ADDRESS("generatetoaddress", 1, 2),
	SET_TX_FEE("settxfee", 1, 1),
	SIGN_MESSAGE("signmessage", 2, 2),
	SIGN_RAW_TRANSACTION("signrawtransaction", 1, 4),
	SIGN_RAW_TRANSACTION_WITH_KEY("signrawtransactionwithkey", 1, 4),
	STOP("stop", 0, 0),
	...
	// omni
	GET_OMNI_TRANSACTION("omni_gettransaction", 1, 1),
	GET_OMNI_LISTTRANSACTIONSINBLOCK("omni_listblocktransactions", 1, 1),
	CREATE_OMNI_PAYLOAD_SIMPLESEND("omni_createpayload_simplesend", 2, 2),
	CREATE_OMNI_RAWTX_OPRETURN("omni_createrawtx_opreturn", 2, 2),
	CREATE_OMNI_RAWTX_REFERENCE("omni_createrawtx_reference", 2, 2),
	CREATE_OMNI_RAWTX_CHANGE("omni_createrawtx_change", 4, 4),
	GET_OMNI_BALANCE("omni_getbalance",2,2);
