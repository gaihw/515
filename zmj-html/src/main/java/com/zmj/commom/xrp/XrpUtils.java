...
public class XrpUtils {
    ...
    public String transaction(XrpChain xrpChain){
        ...
        String tx_blob = sign(xrpChain.getFromAddress(), xrpChain.getSecret(), xrpChain.getToAddress(), xrpChain.getValue(), xrpChain.getFee(),xrpChain.getMemo());
     ...
     * @return
     */
    public  String sign(String fromAddress, String secret, String toAddress, BigDecimal value, BigDecimal fee, String memo) {
