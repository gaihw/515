...
//        System.out.println("Hash==>" + ethBlock.getBlock().getHash());
     ...
     * @throws Exception
     */
    public  String transaction(Web3j web3, String toAddress, BigInteger gasPrice, BigInteger gasLimit, BigInteger value, Credentials credentials) throws Exception {
     ...
     * @return
     */
    public Credentials getCre(String password, JSONObject text){
