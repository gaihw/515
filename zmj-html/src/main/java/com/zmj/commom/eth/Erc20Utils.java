...
public class Erc20Utils {
     ...
     * @throws Exception
     */
    public  EthSendTransaction transferERC20Token(Web3j web3, String from, String to, BigInteger value, String privateKey, String contractAddress, byte chainId) throws Exception {
