...
public class AllTimeChange {
    public static void main(String[] args) {
        ...
        url_changeTime.add("http://192.168.200.168:8081/dynamic/config/delay/update/batch");//币本位
...
//        getTime(userIds,url_getTime.get(1));
        changeTime(userIds,url_changeTime.get(0),0);
    ...
    public static void getTime(List<String> userIds,String url){
        for(String userId:userIds){
            ...
            System.out.println(BaseUtils.postByForm(url,params));
        }
    }
            ...
            for(String userId:userIds){
                ...
                if (index == 0){
                    if(userId.equals("333388222")){
                        ...
                        jsonb.put("contractDelayMap",JSONObject.parseObject("{\"1\":\"1200\",\"2\":\"7000\",\"4\":\"1200\",\"5\":\"2000\",\"6\":\"2200\",\"7\":\"7000\",\"8\":\"7200\",\"9\":\"2100\"}"));
                    }else if(userId.equals("333385143")){
                        jsonb.put("contractDelayMap",JSONObject.parseObject("{\"1\":\"2100\",\"2\":\"8500\",\"4\":\"1200\",\"5\":\"6000\",\"6\":\"2100\",\"8\":\"7500\",\"9\":\"6000\"}"));
                    }else {
