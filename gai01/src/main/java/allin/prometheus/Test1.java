...
public class Test1 {
    ...
    public static Logger log = LoggerFactory.getLogger(Test1.class);
    public static void main(String[] args) throws UnknownHostException {
        ...
        String instance = "";
        String token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyVXVpZCI6IjVkYzFlMWEzLTQ1NjEtNGI3MC1iOTM3LTYyMDc3NmQ1YzVkYiIsImV4cCI6MTYyNzYxMjM2NiwidXNlcklkIjoiMTU5MSIsInRpbWVzdGFtcCI6IjE2Mjc1MjU5NjYwMTMifQ.BxaoEx5maMEFdpKZXvZvw0iNneKS_l479wJ4IaW7hpI";
        String uid = "5dc1e1a3-4561-4b70-b937-620776d5c5db";
        long startIme = 1627526460;
        long endTime = 1627527060;
        ...
        for (Document metric:metric_document){
            ...
            instance = jsonObject.getJSONObject("property").getJSONArray("instance").getString(0);
...
//            }
            ...
            String metric_search_params = "{\"pageSize\":10,\"pageNo\":1,\"filter\":{\"searchType\":\"METRIC_RANGE\",\"metricId\":[\""+metricID+"\"],\"paramMap\":{\""+metricID+"\":{\"服务实例\":\""+instance+"\"}},\"startTime\":"+startIme+",\"endTime\":"+endTime+",\"step\":\"1m\"}}";
            //""{\"pageSize\":10,\"pageNo\":1,\"filter\":{\"searchType\":\"METRIC_RANGE\",\"metricId\":[\""+metricID+"\"],\"paramMap\":{\""+metricID+"\":{}},\"startTime\":"+startIme+",\"endTime\":"+endTime+",\"step\":\"1m\"}}";
            ...
            for (int i = 0; i < prometheus_result.size(); i++) {
                if (prometheus_result.getJSONObject(i).getJSONObject("metric").containsKey("english_service_name")) {
                    ...
                    if (prometheus_result.getJSONObject(i).getJSONObject("metric").getString("english_service_name").equals(englishServiceName)
                            ...
                            && prometheus_result.getJSONObject(i).getJSONObject("metric").getString("instance").contains(instance)) {
                        for (int j = 0; j < prometheus_result.getJSONObject(i).getJSONArray("values").size(); j++) {
                            ...
                            System.out.println("run >>> " + metricID+":::::"+name);
