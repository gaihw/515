...
public class GenWalletGenAcct {
        ...
        //of your node.
        final String KMD_API_ADDR = "http://192.168.112.89:9080";
        final String KMD_API_TOKEN = "81be2652f02c9e62a32236952558fa2a6be89a2d34563351e874aee48ab24cd1";
        ...
        System.out.println(api_key.getParamName());
...
//            System.out.println(req.getWalletName());
//            //create the wallet
