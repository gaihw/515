...
public class Bchn {
    static {
        System.setProperty("fileName", "bch/bch.log");
    }
...
//        JSONObject blockhash = JSONObject.parseObject(getblockhash(662188));
//        System.out.println(blockhash.getString("result"));
//        System.out.println(getblock(blockhash.getString("result")));
    ...
    public static void transactionToHot(){
        ...
        String vout = null;
        //热钱包地址
        String hotAddress = "moiEMimM4THDRMiHKVvyRWbNJSZ5QsHuKb";
...
//        }
    ...
    public static String createrawtransaction(String txid,String vout,String fromAddress,String toAddress,String value,String value1,String scriptPubKey,BigDecimal amount,String privateKey,String redeemScript){
        ...
        String rr = Utils.postByJson("http://"+Config.BCH_URL+":"+Config.BCH_PORT,cred,params);
        System.out.println("rr==="+rr);
...
//        System.out.println(params);
     ...
     * 获取块hash
     */
    public static String getblockhash(int num){
        Base64.Encoder encoder = Base64.getEncoder();
        String cred = encoder.encodeToString((Config.BTC_USERNMAME + ":" + Config.BTC_PASSWORD).getBytes());
        String params = "{\"jsonrpc\": \"2.0\", \"id\": \"curltest\", \"method\": \"getblockhash\", \"params\": ["+num+"]}";
        return Utils.postByJson("http://"+Config.BCH_URL+":"+Config.BCH_PORT,cred,params);
    }
    /**
     * 查询块信息
    ...
    public static String getblock(String blockhash){
        Base64.Encoder encoder = Base64.getEncoder();
        String cred = encoder.encodeToString((Config.BTC_USERNMAME + ":" + Config.BTC_PASSWORD).getBytes());
        String params = "{\"jsonrpc\": \"2.0\", \"id\": \"curltest\", \"method\": \"getblock\", \"params\": [\""+blockhash+"\"]}";
        return Utils.postByJson("http://"+Config.BCH_URL+":"+Config.BCH_PORT,cred,params);
    }
