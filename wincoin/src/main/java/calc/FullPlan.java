...
public class FullPlan {
    ...
    public static Logger log = LoggerFactory.getLogger(FullPlan.class);
    public static String userId = Config.userId;

    public static void main(String[] args) throws SQLException {
        log.info("------FullPlan start------");
        ...
        String orderId = JSONObject.parseObject(CommonUtil.open(currencyName,1,1,direction,leverage,1,1,BigDecimal.valueOf(200),0,BigDecimal.valueOf(50),BigDecimal.valueOf(60))).getString("data");
        //下单后，查询订单表，对应的订单信息
