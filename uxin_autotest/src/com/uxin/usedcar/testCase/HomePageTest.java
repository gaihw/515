...
//				CheckViewVisibilty(By.id("ivRefresh"))) {
	...
	/**
	 * @Name 1900_RMTJ_city
	 * @Catalogue 首页-热门推荐-非全国直购城市切换
	 * @Grade 高级
	 * @FunctionPoint 首页-热门推荐切换非全国直购城市阿克苏
	 **/

//	@Test
//	public void test_1900_RMTJ_city(){
//		reports_HomePageTest.startTest("test_1900_RMTJ_city");
//		gotocate(1);
//		wait(1);
//		try {
//			clickElementById("btChooseCity");//切换城市
//			wait(1);
//			clickElementByName("阿克苏");
//			wait(1);			
//			clickButtonShouYe("分期购");
...
////			clickButtonShouYe("分期购");
////			wait(1);
////			if(findElementById("tv_pop_content").getText().equals("分期购")){
////				reports_HomePageTest.log(LogStatus.INFO, "阿克苏展示分期购，逻辑正确");
////				System.out.println("阿克苏展示分期购，逻辑正确");
////			}else {
////				System.out.println("阿克苏没有展示分期购，逻辑错误，请人工检查");
////				failAndMessage("阿克苏没有展示分期购，逻辑错误，请人工检查");
////			}
////			driver.pressKeyCode(AndroidKeyCode.BACK);
////			wait(1);
//			clickButtonShouYe("优信金牌认证");
//			wait(1);
//			if(findElementById("tv_pop_content").getText().equals("优信金牌认证")){
//				reports_HomePageTest.log(LogStatus.INFO, "阿克苏展示优信金牌认证，逻辑正确");
//				System.out.println("阿克苏展示优信金牌认证，逻辑正确");
//			}else {
//				System.out.println("阿克苏没有展示优信金牌认证，逻辑错误，请人工检查");
//				failAndMessage("阿克苏没有展示优信金牌认证，逻辑错误，请人工检查");
//			}
//			driver.pressKeyCode(AndroidKeyCode.BACK);
//			wait(1);
//			clickButtonShouYe("优信金牌认证");
...
//	}
	...
	public void test_1000_CITY() {
		reports_HomePageTest.startTest("test_1000_CITY");
		gotocate(1);
		reports_HomePageTest.log(LogStatus.INFO, "检查当前城市定位是否为北京。");
		if(!findElementById("btChooseCity").getText().equals("北京")) {
			reports_HomePageTest.log(LogStatus.ERROR, "当前城市定位不是北京，请检查！");
		...
		try {
			...
			gotoCateSet(1);   //车市
			wait(3);
			if(findElementById("btChooseCity").getText().equals("成都")) {
				reports_HomePageTest.log(LogStatus.INFO, "首页修改城市可以正常同步到买车页。");
				System.out.println("首页修改城市可以正常同步到买车页。");
			}
			else {
				reports_HomePageTest.log(LogStatus.ERROR, "首页修改城市没有同步到买车页，请检查。");
...
//				}else {
//					GetScreenshot("test_1700_search_1_tv_search");
//					failAndMessage("搜索历史，搜索失败");
//					reports_HomePageTest.log(LogStatus.ERROR,"搜索历史，搜索失败");
//				}
		}else {
			GetScreenshot("test_1700_search_1_searchPage");
			failAndMessage("没有找到对应的搜索历史");
			reports_HomePageTest.log(LogStatus.ERROR,"没有找到对应的搜索历史");
		}
	}
	}
...
//	/**
//	 * @Name 1706_search
//	 * @Catalogue 首页-搜索-店铺历史记录
//	 * @Grade 高级
//	 * @FunctionPoint 首页-搜索功能-点击店铺历史记录中直接搜索
//	 */
//	@Test
//	public void test_1706_search() {
//		reports_HomePageTest.startTest("test_1706_search");
//		gotocate(1);
//		reports_HomePageTest.log(LogStatus.INFO, "点击搜索框");
//		clickElementById("tv_search");
//		wait(1);
...
//		if(CheckViewVisibilty(By.id("ivDelete"))) {
//			clickElementById("tvSearchHistory");//点击店铺搜索历史，进入店铺详情
//			sleep(500);
//			checkTitlebar1("店铺详情");
//			if(CheckViewVisibilty(By.id("rlGuanZhu"))&&   //关注店铺
//					CheckViewVisibilty(By.id("rlLiaoTian"))) {  //在线聊天
//				reports_HomePageTest.log(LogStatus.INFO, "点击搜索店铺历史进入店铺详情页！");
//				System.out.println("点击搜索店铺历史进入店铺详情页！");
//			}
//		}else {
//			reports_HomePageTest.log(LogStatus.INFO, "没有店铺搜索历史，创建一个店铺搜索历史。");
//			input("id", "etSearchText", "", "奥迪", "");
//			wait(1);
...
//				sleep(500);
//				checkTitlebar1("店铺详情");
//				if(CheckViewVisibilty(By.id("rlGuanZhu"))&&
//						CheckViewVisibilty(By.id("rlLiaoTian"))) {
//					reports_HomePageTest.log(LogStatus.INFO, "点击搜索店铺历史进入店铺详情页！");
//					System.out.println("点击搜索店铺历史进入店铺详情页！");
//				}
//			}else {
//				reports_HomePageTest.log(LogStatus.ERROR, "搜索店铺创建搜索历史失败！");
//				failAndMessage("搜索店铺创建搜索历史失败！");
//			}
//			
//		}
//	}
...
//	 * @Catalogue 首页-搜索
//	 * @Grade 高级
//	 * @FunctionPoint 首页-搜索功能-清空店铺搜索历史记录
//	 */
//	@Test
//	public void test_1707_search() {
//		reports_HomePageTest.startTest("test_1707_search");
//		gotocate(1);
//		reports_HomePageTest.log(LogStatus.INFO, "点击搜索框");
//		clickElementById("tv_search");
//		wait(1);
...
//			sleep(500);
//			if(CheckViewVisibilty(By.id("tvDialogMessage"))) {    //是否清除搜索历史
//				clickElementByName("删除");
//				wait(1);
//				if(!CheckViewVisibilty(By.id("ivDelete"))) {
//					reports_HomePageTest.log(LogStatus.INFO, "搜索店铺历史删除成功！");
//					System.out.println("搜索店铺历史删除成功！");
//				}else {
//					reports_HomePageTest.log(LogStatus.ERROR, "搜索店铺历史删除失败！");
//					failAndMessage("搜索店铺历史删除失败！");
//				}
//			}else {
//				reports_HomePageTest.log(LogStatus.ERROR, "搜索店铺历史删除失败！");
//				failAndMessage("搜索店铺历史删除失败！");
...
//			clickElementById("alertdialog_shop");
//			if(CheckViewVisibilty(By.id("ivDelete"))) {
//				reports_HomePageTest.log(LogStatus.INFO, "创建搜索店铺历史成功！");
//				clickElementById("ivDelete");
//				if(CheckViewVisibilty(By.id("tvDialogMessage"))) {    //是否清除搜索历史
//					clickElementByName("删除");
//					wait(1);
...
//	}
	...
	public void test_1710_search_suggest() {
		reports_HomePageTest.startTest("test_1710_search_suggest");
		gotocate(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击搜索栏");
		clickElementById("tv_search");
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "搜索栏输入“奥迪”。");
		input("id", "etSearchText", "", "啊", "");
		List<WebElement> list = findElementById("lvTips").findElements(By.id("linLayItemLayout"));
		if(list.size() > 10) {
			reports_HomePageTest.log(LogStatus.ERROR, "搜索“奥迪”的suggest词个数超过10，请检查。");
			GetScreenshot("test_1710_search_suggest");
			failAndMessage("搜索“奥迪”的suggest词个数超过10，请检查。");
		}else {
			reports_HomePageTest.log(LogStatus.INFO, "搜索“奥迪”的suggest词个数未超过10，显示正确。");
...
//		reports_HomePageTest.startTest("test_1708_DPMR");
//		gotocate(1);
//		reports_HomePageTest.log(LogStatus.INFO, "点击搜索栏");
//		clickElementById("tv_search");
//		wait(1);
//		reports_HomePageTest.log(LogStatus.INFO, "切换为店铺搜索。");
//		clickElementById("tvSearch");//点击车辆/店铺切换按钮
//		clickElementById("alertdialog_shop");
//		reports_HomePageTest.log(LogStatus.INFO, "输入“。。。”，然后回车。");
//		input("id", "etSearchText", "", "。。。", "");
//		driver.pressKeyCode(AndroidKeyCode.ENTER);
//		sleep(500);
//		checkTitlebar1("店铺详情");
//		if(CheckViewVisibilty(By.id("tvDirectStatusNull"))) {
//			reports_HomePageTest.log(LogStatus.INFO, "搜索“。。。”店铺，没有相关店铺，进入店铺默认图！");
//			System.out.println("搜索“。。。”店铺，没有相关店铺，进入店铺默认图！");
//		}else if(CheckViewVisibilty(By.id("rlGuanZhu"))){
//			reports_HomePageTest.log(LogStatus.INFO, "搜索“。。。”店铺，有相关店铺，进入店铺详情！");
//			System.out.println("搜索“。。。”店铺，有相关店铺，进入店铺详情！");
//		}else {
//			reports_HomePageTest.log(LogStatus.ERROR, "搜索“。。。”店铺，没有相关店铺，但也没有进入店铺默认图！请检查！");
...
//	}
	...
	public void test_1702_search(){
		reports_HomePageTest.startTest("test_1700_search_2");
		gotocate(1);
		clickElementById("tv_search");
		wait(1);
    	reports_HomePageTest.log(LogStatus.PASS, "光标聚焦在搜索框");
    	if(CheckViewVisibilty(By.id("ivDelete"))){
    		...
    		if (CheckViewVisibilty(By.id("flowLayoutHistory"))) {
    			...
    			reports_HomePageTest.log(LogStatus.ERROR, "删除历史记录失败");
			}
    	}else {
			System.out.println("没有搜索历史");
			reports_HomePageTest.log(LogStatus.INFO, "没有搜索历史，开始创建搜索历史");
	    	...
	    	reports_HomePageTest.log(LogStatus.PASS, "光标聚焦在搜索框");
	    	if(CheckViewVisibilty(By.id("ivDelete"))){
	    		reports_HomePageTest.log(LogStatus.INFO, "删除搜索历史");
	    		clickElementById("ivDelete");
	    		wait(1);
	    		clickElementById("bt_confirm_ok");
	    		if (CheckViewVisibilty(By.id("flowLayoutHistory"))) {
...
//		reports_HomePageTest.startTest("test_1700_search_3");
//		gotocate(1);
//		reports_HomePageTest.log(LogStatus.INFO, "点击搜索框");
//		clickElementById("tv_search");
//		wait(1);
...
//			reports_HomePageTest.log(LogStatus.INFO, "搜索店铺<优车诚>");
...
//			reports_HomePageTest.log(LogStatus.INFO, "关注店铺");
//			toastCheck("关注店铺成功");
//			clickElementById("ivGuanZhu");
//			toastCheck("取消关注成功");
//			
...
//			reports_HomePageTest.log(LogStatus.ERROR, "切换店铺搜索失败");
//		}
//	}
	...
	public void test_1705_search()  {
		reports_HomePageTest.startTest("test_1700_search_5");
		gotocate(1);
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击搜索框");
		clickElementById("tv_search");
...
//		System.out.println("总数="+itemContent);
		for (int i = 0; i <hotSearch.length; i++) {
			reports_HomePageTest.log(LogStatus.INFO, "开始遍历热门搜索");
			...
			if(CheckViewVisibilty(By.id("tv_pop_content"))) {
				...
				reports_HomePageTest.log(LogStatus.ERROR, "热门搜索第"+i+"个,点击后跳转错误,应为>"+hotSearch[i]+"<实际为>"+findElementById("tv_search").getText());
			}
		}
	}
	...
	public void test_1200_XXZX() {
		reports_HomePageTest.startTest("test_1200_XXZX");
		gotocate(1);
		wait(1);
		clickElementById("message");
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击首页消息中心");
		checkTitlebar1("消息中心");
		reports_HomePageTest.log(LogStatus.INFO, "点击首页进入到消息中心");
	...
	public void test_1100_MC() {
		reports_HomePageTest.startTest("test_1100_MC");
		gotocate(1);
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击首页的买车商城。");
		clickButtonShouYe("买车商城");
		CheckNewListFromHomePage();
		reports_HomePageTest.log(LogStatus.INFO, "首页，点击买车商城，进入买车列表新页面。");
    	System.out.println("首页，点击买车商城，进入买车列表新页面。");
    	toDetailFromNewList();
    	checkTitlebar_Detail();
    	backBTN();
		backBTN();
		reports_HomePageTest.log(LogStatus.INFO, "点击首页的查看全部车源按钮。");
		clickElementById("cartotal");//查看全部XXXX车源
		wait(1);
		CheckNewListFromHomePage();
		reports_HomePageTest.log(LogStatus.INFO, "首页，点击查看全部车源按钮，进入买车列表新页面。");
	...
	public void test_1210_MC_ZM() {
		reports_HomePageTest.startTest("test_1210_MC_ZM");
		gotocate(1);
		wait(3);
		clickButtonShouYe("卖车通道");
		reports_HomePageTest.log(LogStatus.INFO, "点击首页-卖车通道");
		wait(5);
		if(findElementByName("卖车").getAttribute("checked").equals("true")){
        	reports_HomePageTest.log(LogStatus.INFO, "首页，点击卖车通道，进入卖车tab页。");
        	System.out.println("首页，点击首页-卖车通道，进入卖车tab页。");
        }else {
        	reports_HomePageTest.log(LogStatus.ERROR, "首页，点击卖车通道，没有进入卖车tab页。");
	...
	public void test_1200_CLGJ() {
		 reports_HomePageTest.startTest("test_1200_CLGJ"); 
		 gotocate(1);
		 sleep(200);
		 clickButtonShouYe("免费估价");
		 reports_HomePageTest.log(LogStatus.INFO, "点击免费估价");
		 checkTitlebar1("车辆估价");
		 ...
		 for(int i=1; i<str.length;i++){
				...
				if(CheckViewVisibilty(By.xpath("//android.widget.FrameLayout[1]/android.widget.LinearLayout[1]"
					...
					System.out.println(findElementByXpath("//android.widget.FrameLayout[1]/android.widget.LinearLayout[1]"
							+ "/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]"
							+ "/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.ScrollView[1]"
							+ "/android.widget.LinearLayout[1]/android.widget.LinearLayout["+i+"]/android.widget.TextView[1]"));
					if (findElementByXpath("//android.widget.FrameLayout[1]/android.widget.LinearLayout[1]"
							+ "/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]"
							+ "/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.ScrollView[1]"
							+ "/android.widget.LinearLayout[1]/android.widget.LinearLayout["+i+"]"
									+ "/android.widget.TextView[1]").getText().equals(str[i-1])) {
						
					}else {
						failAndMessage(str[i-1]+"没有正常显示");
						reports_HomePageTest.log(LogStatus.ERROR,str[i-1]+"没有正常显示");
						break;
					}
				}						
		 }
		 if(findElementById("tv_select_brand").getText().equals("品牌车系")) {
			...
			reports_HomePageTest.log(LogStatus.ERROR, "品牌车系没有正常显示");
		}
		 if(findElementById("tv_car_self_evaluation_title").getText().equals("车况自评")) {
			 
		 }else {
			failAndMessage("车况自评没有正常显示");
			reports_HomePageTest.log(LogStatus.ERROR, "车况自评没有正常显示");
		}
	}
	...
	public void test_1400_GJ() {
		reports_HomePageTest.startTest("test_1400_GJ");
		gotocate(1);
		clickButtonShouYe("免费估价");
		sleep(200);
		checkTitlebar1("车辆估价");
...
//				CheckViewVisibilty(By.id("ll_car_license_plate"))&&
			...
			reports_HomePageTest.log(LogStatus.INFO, "车辆估价页面显示正常。");
			System.out.println("车辆估价页面显示正常。");		
			reports_HomePageTest.log(LogStatus.INFO, "车辆估价页面-选择要卖的车。");
			...
			reports_HomePageTest.log(LogStatus.INFO, "车辆估价页面-输入里程。");
			findElementById("et_vehicle_condition").sendKeys("25");
			reports_HomePageTest.log(LogStatus.INFO, "车辆估价页面-选择上牌时间。");
			...
			sleep(500);
			reports_HomePageTest.log(LogStatus.INFO, "车辆估价页面-检查开始估价按钮是否变为可用。");
			if(findElementById("btn_commit").getAttribute("enabled").equals("true")) {
				reports_HomePageTest.log(LogStatus.INFO, "车辆估价页面-输入所有信息之后，开始估价按钮变为可用。");
				System.out.println("车辆估价页面-输入所有信息之后，开始估价按钮变为可用。");
			}
			else {
				reports_HomePageTest.log(LogStatus.ERROR, "车辆估价页面-输入所有信息之后，开始估价按钮仍然不可用，请检查。");
				GetScreenshot("test_1400_GJ_button");
				failAndMessage("车辆估价页面-输入所有信息之后，开始估价按钮仍然不可用，请检查。");
			}
		}else {
			reports_HomePageTest.log(LogStatus.ERROR, "车辆估价页面显示异常。");
	...
	public void test_1300_ZNXC() {
		reports_HomePageTest.startTest("test_1300_ZNXC");
		gotocate(1);
		wait(2);
		reports_HomePageTest.log(LogStatus.INFO, "点击购车顾问");
		clickButtonShouYe("购车顾问");
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击智能选车");
...
//		clickElementByName("我是您的专属购车顾问，可以帮您更快更准的筛选超值好车，您也可以体验人工智能选车，点击体验");
		...
		if(findElementById("askquestionstr").getText().equals("您更喜欢什么样类型的车？")) {
			...
			if(findElementById("askquestionstr").getText().equals("选择您最关注的内容")) {
				...
				if(findElementById("confirm").equals("条件太苛刻，请重新选择")) {
					reports_HomePageTest.log(LogStatus.INFO, "条件太苛刻，没有合适车源。");
					System.out.println("条件太苛刻，没有合适车源。");
				}else {
					clickElementById("confirm");
					if(CheckViewVisibilty(By.id("carname"))) {
						reports_HomePageTest.log(LogStatus.INFO, "智能选车有合适车源。");
	...
	public void test_1300_ZNXC_MODIFY() {
		reports_HomePageTest.startTest("test_1300_ZNXC_MODIFY");
		gotocate(1);
		wait(2);
		reports_HomePageTest.log(LogStatus.INFO, "点击购车顾问");
		clickButtonShouYe("购车顾问");
...
//		clickElementByName("我是您的专属购车顾问，可以帮您更快更准的筛选超值好车，您也可以体验人工智能选车，点击体验");
		...
		if(findElementById("askquestionstr").getText().equals("您更喜欢什么样类型的车？")) {
			...
			if(findElementById("askquestionstr").getText().equals("选择您最关注的内容")) {
				...
				if(findElementById("tv_car_types").getText().equals("SUV")) {
					reports_HomePageTest.log(LogStatus.INFO, "智能选车，车型修改成功。");
					System.out.println("智能选车，车型修改成功。");
				}else {
					reports_HomePageTest.log(LogStatus.ERROR, "智能选车，车型修改失败。");
	...
	public void test_1300_ZNXC_RESULT_LIST() {
		reports_HomePageTest.startTest("test_1300_ZNXC_RESULT_LIST");
		gotocate(1);
		wait(2);
		reports_HomePageTest.log(LogStatus.INFO, "点击购车顾问");
		clickButtonShouYe("购车顾问");
				...
				if(findElementById("confirm").equals("条件太苛刻，请重新选择")) {
					...
					if(CheckViewVisibilty(By.id("carname"))) {
						...
						if(CheckViewVisibilty(By.id("price"))&&//车价
							...
							reports_HomePageTest.log(LogStatus.INFO, "智能选车的结果车系列表显示正确。");
							System.out.println("智能选车的结果车系列表显示正确。");	
						}else {
							reports_HomePageTest.log(LogStatus.ERROR, "智能选车的结果车系列表显示异常，请查看。");
							failAndMessage("智能选车的结果车系列表显示异常，请查看。");
						}
						reports_HomePageTest.log(LogStatus.INFO, "进入某个车系的车源详情列表。");
...
//								CheckViewVisibilty(By.id("tvCityName"))&&//城市
							...
							reports_HomePageTest.log(LogStatus.INFO, "智能选车结果车源列表，车辆信息显示正常。");
							System.out.println("智能选车结果车源列表，车辆信息显示正常。");
						}else {
							reports_HomePageTest.log(LogStatus.ERROR, "智能选车结果车源列表，车辆信息显示异常。");
	...
	public void test_1300_ZNXC_RESULT_SORT() {
		reports_HomePageTest.startTest("test_1300_ZNXC_RESULT_SORT");
		gotocate(1);
		wait(2);
		reports_HomePageTest.log(LogStatus.INFO, "点击购车顾问");
		clickButtonShouYe("购车顾问");
...
//		clickElementByName("我是您的专属购车顾问，可以帮您更快更准的筛选超值好车，您也可以体验人工智能选车，点击体验");
		...
		if(findElementById("askquestionstr").getText().equals("您更喜欢什么样类型的车？")) {
			...
			if(findElementById("askquestionstr").getText().equals("选择您最关注的内容")) {
				...
				if(findElementById("confirm").equals("条件太苛刻，请重新选择")) {
					...
					if(s1 >= s2) {
						reports_HomePageTest.log(LogStatus.INFO, "智能选车结果列表推荐分值由高到低排序正确。");
						System.out.println("智能选车结果列表推荐分值由高到低排序正确。");
					}else {
						reports_HomePageTest.log(LogStatus.ERROR, "智能选车结果列表推荐分值不是由高到低，排序不正确。");
	...
	public void test_1300_ZNXC_BRAND_TAG() {
		reports_HomePageTest.startTest("test_1300_ZNXC_BRAND_TAG");
		gotocate(1);
		wait(2);
		reports_HomePageTest.log(LogStatus.INFO, "点击购车顾问");
		clickButtonShouYe("购车顾问");
...
//		clickElementByName("我是您的专属购车顾问，可以帮您更快更准的筛选超值好车，您也可以体验人工智能选车，点击体验");
		...
		if(findElementById("askquestionstr").getText().equals("您更喜欢什么样类型的车？")) {
			...
			if(findElementById("askquestionstr").getText().equals("选择您最关注的内容")) {
				int width = driver.manage().window().getSize().width;
				int hight = driver.manage().window().getSize().height;
				reports_HomePageTest.log(LogStatus.INFO, "最关注的内容选择品牌");
				...
				if(findElementById("confirm").equals("条件太苛刻，请重新选择")) {
					...
					if(findElementById("tag").getText().equals("品牌最响亮")) {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择品牌，对应匹配的文案正确。");
						System.out.println("最关注的选择品牌，对应匹配的文案正确。");
					}else {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择品牌，对应匹配的文案不正确，请检查。");
	...
	public void test_1300_ZNXC_CROSS_COUNTRY_TAG() {
		reports_HomePageTest.startTest("test_1300_ZNXC_COUNTRY_TAG");
		gotocate(1);
		wait(2);
		reports_HomePageTest.log(LogStatus.INFO, "点击购车顾问");
		clickButtonShouYe("购车顾问");
...
//		clickElementByName("我是您的专属购车顾问，可以帮您更快更准的筛选超值好车，您也可以体验人工智能选车，点击体验");
		...
		if(findElementById("askquestionstr").getText().equals("您更喜欢什么样类型的车？")) {
			...
			if(findElementById("askquestionstr").getText().equals("选择您最关注的内容")) {
				int width = driver.manage().window().getSize().width;
				int hight = driver.manage().window().getSize().height;
				reports_HomePageTest.log(LogStatus.INFO, "最关注的内容选择越野");
				...
				if(findElementById("confirm").equals("条件太苛刻，请重新选择")) {
					...
					if(findElementById("tag").getText().equals("越野最出色")) {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择越野，对应匹配的文案正确。");
						System.out.println("最关注的选择越野，对应匹配的文案正确。");
					}else {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择越野，对应匹配的文案不正确，请检查。");
	...
	public void test_1300_ZNXC_SAFE_TAG() {
		reports_HomePageTest.startTest("test_1300_ZNXC_SAFE_TAG");
		gotocate(1);
		wait(2);
		reports_HomePageTest.log(LogStatus.INFO, "点击购车顾问");
		clickButtonShouYe("购车顾问");
...
//		clickElementByName("我是您的专属购车顾问，可以帮您更快更准的筛选超值好车，您也可以体验人工智能选车，点击体验");
		...
		if(findElementById("askquestionstr").getText().equals("您更喜欢什么样类型的车？")) {
			...
			if(findElementById("askquestionstr").getText().equals("选择您最关注的内容")) {
				int width = driver.manage().window().getSize().width;
				int hight = driver.manage().window().getSize().height;
				reports_HomePageTest.log(LogStatus.INFO, "最关注的内容选择安全");
				...
				if(findElementById("confirm").equals("条件太苛刻，请重新选择")) {
					...
					if(findElementById("tag").getText().equals("五星安全")) {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择安全，对应匹配的文案正确。");
						System.out.println("最关注的选择安全，对应匹配的文案正确。");
					}else {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择安全，对应匹配的文案不正确，请检查。");
	...
	public void test_1300_ZNXC_SPACE_TAG() {
		reports_HomePageTest.startTest("test_1300_ZNXC_SPACE_TAG");
		gotocate(1);
		wait(2);
		reports_HomePageTest.log(LogStatus.INFO, "点击购车顾问");
		clickButtonShouYe("购车顾问");
...
//		clickElementByName("我是您的专属购车顾问，可以帮您更快更准的筛选超值好车，您也可以体验人工智能选车，点击体验");
		...
		if(findElementById("askquestionstr").getText().equals("您更喜欢什么样类型的车？")) {
			...
			if(findElementById("askquestionstr").getText().equals("选择您最关注的内容")) {
				int width = driver.manage().window().getSize().width;
				int hight = driver.manage().window().getSize().height;
				reports_HomePageTest.log(LogStatus.INFO, "最关注的内容选择空间");
				driver.tap(1, width/2, hight*9/20, 1);//空间
				if(findElementById("confirm").getText().equals("至少选择2项（1/6）")) {
					reports_HomePageTest.log(LogStatus.INFO, "选了一个最关注的内容");
					System.out.println("选了一个最关注的内容");
				...
				if(findElementById("confirm").equals("条件太苛刻，请重新选择")) {
					...
					if(findElementById("tag").getText().equals("空间最理想")) {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择空间，对应匹配的文案正确。");
						System.out.println("最关注的选择空间，对应匹配的文案正确。");
					}else {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择空间，对应匹配的文案不正确，请检查。");
	...
	public void test_1300_ZNXC_CONFIG_TAG() {
		reports_HomePageTest.startTest("test_1300_ZNXC_CONFIG_TAG");
		gotocate(1);
		wait(2);
		reports_HomePageTest.log(LogStatus.INFO, "点击购车顾问");
		clickButtonShouYe("购车顾问");
...
//		clickElementByName("我是您的专属购车顾问，可以帮您更快更准的筛选超值好车，您也可以体验人工智能选车，点击体验");
		...
		if(findElementById("askquestionstr").getText().equals("您更喜欢什么样类型的车？")) {
			...
			if(findElementById("askquestionstr").getText().equals("选择您最关注的内容")) {
				int width = driver.manage().window().getSize().width;
				int hight = driver.manage().window().getSize().height;
				reports_HomePageTest.log(LogStatus.INFO, "最关注的内容选择配置");
				driver.tap(1, width/2, hight*5/8, 1);//配置
				if(findElementById("confirm").getText().equals("至少选择2项（1/6）")) {
					reports_HomePageTest.log(LogStatus.INFO, "选了一个最关注的内容");
					System.out.println("选了一个最关注的内容");
				...
				if(findElementById("confirm").equals("条件太苛刻，请重新选择")) {
					...
					for(int i=0; i<tagList.size(); i++) {
						if(tagList.get(i).getText().equals("配置最贴心")) {
							reports_HomePageTest.log(LogStatus.INFO, "最关注的选择配置，智能选车结果页有对应匹配的文案。");
							System.out.println("最关注的选择配置，智能选车结果页有对应匹配的文案。");
							break;
						}else if(i == tagList.size()){
							reports_HomePageTest.log(LogStatus.INFO, "最关注的选择配置，智能选车结果页没有对应匹配的文案，请检查。");
	...
	public void test_1300_ZNXC_JOY_TAG() {
		reports_HomePageTest.startTest("test_1300_ZNXC_JOY_TAG");
		gotocate(1);
		wait(2);
		reports_HomePageTest.log(LogStatus.INFO, "点击购车顾问");
		clickButtonShouYe("购车顾问");
...
//		clickElementByName("我是您的专属购车顾问，可以帮您更快更准的筛选超值好车，您也可以体验人工智能选车，点击体验");
		...
		if(findElementById("askquestionstr").getText().equals("您更喜欢什么样类型的车？")) {
			...
			if(findElementById("askquestionstr").getText().equals("选择您最关注的内容")) {
				int width = driver.manage().window().getSize().width;
				int hight = driver.manage().window().getSize().height;
				reports_HomePageTest.log(LogStatus.INFO, "最关注的内容选择娱乐");
				...
				if(findElementById("confirm").equals("条件太苛刻，请重新选择")) {
					...
					if(findElementById("tag").getText().equals("体验最丰富")) {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择娱乐，对应匹配的文案正确。");
						System.out.println("最关注的选择娱乐，对应匹配的文案正确。");
					}else {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择娱乐，对应匹配的文案不正确，请检查。");
	...
	public void test_1300_ZNXC_POWER_TAG() {
		reports_HomePageTest.startTest("test_1300_ZNXC_POWER_TAG");
		gotocate(1);
		wait(2);
		reports_HomePageTest.log(LogStatus.INFO, "点击购车顾问");
		clickButtonShouYe("购车顾问");
...
//		clickElementByName("我是您的专属购车顾问，可以帮您更快更准的筛选超值好车，您也可以体验人工智能选车，点击体验");
		...
		if(findElementById("askquestionstr").getText().equals("您更喜欢什么样类型的车？")) {
			...
			if(findElementById("askquestionstr").getText().equals("选择您最关注的内容")) {
				int width = driver.manage().window().getSize().width;
				int hight = driver.manage().window().getSize().height;
				reports_HomePageTest.log(LogStatus.INFO, "最关注的内容选择动力");
				...
				if(findElementById("confirm").equals("条件太苛刻，请重新选择")) {
					...
					if(findElementById("tag").getText().equals("动力最强劲")) {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择动力，对应匹配的文案正确。");
						System.out.println("最关注的选择动力，对应匹配的文案正确。");
					}else {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择动力，对应匹配的文案不正确，请检查。");
	...
	public void test_1300_ZNXC_VALUE_TAG() {
		reports_HomePageTest.startTest("test_1300_ZNXC_VALUE_TAG");
		gotocate(1);
		wait(2);
		reports_HomePageTest.log(LogStatus.INFO, "点击购车顾问");
		clickButtonShouYe("购车顾问");
...
//		clickElementByName("我是您的专属购车顾问，可以帮您更快更准的筛选超值好车，您也可以体验人工智能选车，点击体验");
		...
		if(findElementById("askquestionstr").getText().equals("您更喜欢什么样类型的车？")) {
			...
			if(findElementById("askquestionstr").getText().equals("选择您最关注的内容")) {
				int width = driver.manage().window().getSize().width;
				int hight = driver.manage().window().getSize().height;
				reports_HomePageTest.log(LogStatus.INFO, "最关注的内容选择保值");
				...
				if(findElementById("confirm").equals("条件太苛刻，请重新选择")) {
					...
					if(findElementById("tag").getText().equals("车型最保值")) {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择保值，对应匹配的文案正确。");
						System.out.println("最关注的选择保值，对应匹配的文案正确。");
					}else {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择保值，对应匹配的文案不正确，请检查。");
	...
	public void test_1300_ZNXC_DRIVER_TAG() {
		reports_HomePageTest.startTest("test_1300_ZNXC_DRIVER_TAG");
		gotocate(1);
		wait(2);
		reports_HomePageTest.log(LogStatus.INFO, "点击购车顾问");
		clickButtonShouYe("购车顾问");
...
//		clickElementByName("我是您的专属购车顾问，可以帮您更快更准的筛选超值好车，您也可以体验人工智能选车，点击体验");
		...
		if(findElementById("askquestionstr").getText().equals("您更喜欢什么样类型的车？")) {
			...
			if(findElementById("askquestionstr").getText().equals("选择您最关注的内容")) {
				int width = driver.manage().window().getSize().width;
				int hight = driver.manage().window().getSize().height;
				reports_HomePageTest.log(LogStatus.INFO, "最关注的内容选择辅助驾驶");
				...
				if(findElementById("confirm").equals("条件太苛刻，请重新选择")) {
					...
					if(findElementById("tag").getText().equals("驾驶最舒适")) {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择辅助驾驶，对应匹配的文案正确。");
						System.out.println("最关注的选择辅助驾驶，对应匹配的文案正确。");
					}else {
						reports_HomePageTest.log(LogStatus.INFO, "最关注的选择辅助驾驶，对应匹配的文案不正确，请检查。");
	...
	public void test_1300_2SCYCG_MORE() {
		...
		if (findElementById("tv_pop_content").getText().equals("一成购")) {
			...
			reports_HomePageTest.log(LogStatus.ERROR, "一成购列表显示错误");
	...
	public void test_1300_ZSCK() {
		reports_HomePageTest.startTest("test_1300_ZSCK");
		gotocate(1);
		reports_HomePageTest.log(LogStatus.INFO,"点击VR看车按钮");
		clickButtonShouYe("VR看车");
		wait(2);
		if (findElementById("tv_pop_content").getText().equals("VR看车")) {
			CheckNewListFromHomePage();
			reports_HomePageTest.log(LogStatus.INFO, "进入VR看车对应新列表页。");
			System.out.println("进入VR看车对应新列表页。");
			toDetailFromNewList();
			checkTitlebar_Detail();
        	backBTN();
		}else {
			reports_HomePageTest.log(LogStatus.ERROR, "首页，点击VR看车，没有进入VR看车对应新列表页。");
	...
	public void test_1300_CZHC() {
		reports_HomePageTest.startTest("test_1300_CZHC");
		gotocate(1);
		reports_HomePageTest.log(LogStatus.INFO,"点击超值好车按钮");
		clickButtonShouYe("超值好车");
		wait(2);
		if (findElementById("tv_pop_content").getText().equals("超值好车")) {
			CheckNewListFromHomePage();
			reports_HomePageTest.log(LogStatus.INFO, "进入超值好车对应新列表页。");
			System.out.println("进入超值好车对应新列表页。");
			toDetailFromNewList();
			checkTitlebar_Detail();
        	backBTN();
		}else {
			reports_HomePageTest.log(LogStatus.ERROR, "首页，点击超值好车，没有进入超值好车对应新列表页。");
	...
	public void test_1300_3TWLY() {
		reports_HomePageTest.startTest("test_1300_3TWLY");
		gotocate(1);
		reports_HomePageTest.log(LogStatus.INFO,"点击3天无理由按钮");
		clickButtonShouYe("3天无理由");
		wait(2);
		if (findElementById("tv_pop_content").getText().equals("3天无理由")) {
			CheckNewListFromHomePage();
			reports_HomePageTest.log(LogStatus.INFO, "进入3天无理由对应新列表页。");
			System.out.println("进入3天无理由对应新列表页。");
			toDetailFromNewList();
			checkTitlebar_Detail();
        	backBTN();
		}else {
			reports_HomePageTest.log(LogStatus.ERROR, "首页，点击3天无理由，没有进入3天无理由对应新列表页。");
	...
	public void test_1102_RMJG() {
		reports_HomePageTest.startTest("test_1102_RMJG");
		gotocate(1);
		reports_HomePageTest.log(LogStatus.INFO, "开始遍历热门车价");
		String[] str = {"5万以下","5-10万","10-15万","15万以上"};
		String[] listStrings = {"5万以下","5-10万元","10-15万元","15万以上"};
		for (int i = 1; i <= 4; i++) {
			WebElement price= findElementById("price0"+i);
			System.out.println(price.getAttribute("text"));
			if (price.getAttribute("text").equals(str[i-1])) {
				price.click();
				wait(2);
				if (findElementById("tv_pop_content").getText().equals(listStrings[i-1])) {
					...
					reports_HomePageTest.log(LogStatus.ERROR, "列表页筛选条件与预期不符，应为>"+listStrings[i-1]+"。实际为>"+findElementById("tv_pop_content").getText());
					failAndMessage("列表页筛选条件与预期不符，应为>"+listStrings[i-1]+"。实际为>"+findElementById("tv_pop_content").getText());
				}
			}else {
				reports_HomePageTest.log(LogStatus.ERROR, "与预期热门车价不一致，应为>"+str[i-1]+"。实际为>"+price.getAttribute("text"));
				failAndMessage("与预期热门车价不一致，应为>"+str[i-1]+"。实际为>"+price.getAttribute("text"));
			}
		}
	}
	...
	public void test_1101_RMPP() {
		reports_HomePageTest.startTest("test_1100_PPXC");
		gotocate(1);
		wait(1);
		int width = driver.manage().window().getSize().width;
		...
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "开始遍历热门车系");
		...
		for (int i = 0; i < str.length; i++) {
			...
			if (findElementById("tv_pop_content").getText().equals(str[i])) {
				CheckNewListFromHomePage();
				reports_HomePageTest.log(LogStatus.INFO, "进入对应新列表页。");
				...
				reports_HomePageTest.log(LogStatus.ERROR, "没有进入进入预定列表页,应为"+str[i]+",实际为"+waitForVisible(By.id("tvSearchHistory"), 3).getAttribute("text"));
	...
	public void test_1101_RMCX() {
		reports_HomePageTest.startTest("test_1101_RMCX");
		gotocate(1);
		wait(1);
//		int width = driver.manage().window().getSize().width;
//		int height = driver.manage().window().getSize().height;
//		driver.swipe(width/2, height*2/3, width/2, height*1/3, 1000);
//		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "开始遍历热门车型");
	...
	public void test_1000_Start_1(){
		reports_HomePageTest.startTest("test_1000_Start_1");
		gotocate(1);
		sliding("","","","down","");
		reports_HomePageTest.log(LogStatus.INFO, "刷新界面");
		String btChooseCityString = findElementById("btChooseCity").getText();
		if (btChooseCityString.equals("北京")) {
			if(CheckViewVisibilty(By.id("multipletooltext"))&&
					CheckViewVisibilty(By.id("homepage_recyclerview"))&&
					CheckViewVisibilty(By.id("price01"))&&  //3万以下
					CheckViewVisibilty(By.id("cartotal"))&&//查看全部XXX辆车源
					CheckViewVisibilty(By.id("tv_maintenance_title"))) {
				reports_HomePageTest.log(LogStatus.INFO, "首页UI显示正常。");
				System.out.println("首页UI显示正常。");
			}else {
				reports_HomePageTest.log(LogStatus.INFO, "首页UI显示异常。");
				failAndMessage("首页UI显示异常。");
			}
		}else {
			Assert.assertTrue(false,"城市定位有问题，当前城市不是北京");
			reports_HomePageTest.log(LogStatus.ERROR,"城市定位有问题，当前城市不是北京");
		}
	  }
...
//		reports_HomePageTest.startTest("test_1600_YXRZJS");
//		gotocate(1);
//		int width = driver.manage().window().getSize().width;
//		int height = driver.manage().window().getSize().height;
//		driver.swipe(width/2, height*2/3, width/2, height*1/3, 1000);
//		reports_HomePageTest.log(LogStatus.INFO, "点击首页优信金牌认证入口");
...
//		reports_HomePageTest.startTest("test_1904_RMTJ_JRYH");
//		gotocate(1);
//		wait(1);
//		int width = driver.manage().window().getSize().width;
//		int height = driver.manage().window().getSize().height;
...
//		wait(1);
//		reports_HomePageTest.log(LogStatus.INFO, "点击热门推荐今日特惠");
...
//        	backBTN();
//		}else {
//			reports_HomePageTest.log(LogStatus.INFO, "点击今日特惠跳转到的列表页筛选显示不正常");
...
//	}
	...
	public void test_1904_RMTJ_HCJJ() {
		reports_HomePageTest.startTest("test_1904_RMTJ_HCJJ");
		gotocate(1);
		wait(1);
		int width = driver.manage().window().getSize().width;
		int height = driver.manage().window().getSize().height;
		...
		if(CheckViewVisibiltyByName("好车急降")) {
			...
			reports_HomePageTest.log(LogStatus.INFO, "点击热门推荐：好车急降");
			wait(2);
			checkTitlebar1("好车急降");
			reports_HomePageTest.log(LogStatus.INFO, "点击好车急降跳转到正常");
			System.out.println("点击好车急降跳转正常");
		}else {
			clickElementByName("付一成开豪车");
			reports_HomePageTest.log(LogStatus.INFO, "点击热门推荐：付一成开豪车");
			wait(2);
			if (findElementById("tv_pop_content").getText().equals("付一成开豪车")) {
				...
				reports_HomePageTest.log(LogStatus.INFO, "点击付一成开豪车跳转到的列表页筛选显示不正常");
	...
	public void test_1904_RMTJ_TTTJ() {
		reports_HomePageTest.startTest("test_1904_RMTJ_TTTJ");
		gotocate(1);
		wait(1);
		int width = driver.manage().window().getSize().width;
		int height = driver.manage().window().getSize().height;
		driver.swipe(width/2, height*3/4, width/2, height/4, 1000);
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击热门推荐天天特价");
		...
		if (findElementById("tv_pop_content").getText().equals("天天特价")) {
       	...
       	backBTN();
			...
			reports_HomePageTest.log(LogStatus.INFO, "点击天天特价跳转到的列表页筛选显示不正常");
	...
	public void test_1902_RMTJ_JRXS() {
		reports_HomePageTest.startTest("test_1900_RMTJ_JRXS");
		gotocate(1);
		wait(1);
		int width = driver.manage().window().getSize().width;
		int height = driver.manage().window().getSize().height;
		driver.swipe(width/2, height*3/4, width/2, height/4, 1000);
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击热门推荐今日新上");
		...
		if (findElementById("tv_pop_content").getText().equals("今日新上")){
			...
			reports_HomePageTest.log(LogStatus.INFO, "点击今日新上跳转到的列表页筛选显示不正常");
	...
	public void test_1903_RMTJ_ZXC() {
		reports_HomePageTest.startTest("test_1900_RMTJ_ZXC");
		gotocate(1);
		wait(1);
		int width = driver.manage().window().getSize().width;
		int height = driver.manage().window().getSize().height;
		driver.swipe(width/2, height*3/4, width/2, height/4, 1000);
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击热门推荐准新车");
		...
		if (findElementById("tv_pop_content").getText().equals("准新车")){
			...
			reports_HomePageTest.log(LogStatus.INFO, "点击准新车跳转到的列表页筛选显示不正常");
	...
	public void test_1900_RMTJ_SYDB() {
		reports_HomePageTest.startTest("test_1900_RMTJ_SYDB");
		gotocate(1);
		wait(1);
		int width = driver.manage().window().getSize().width;
		int height = driver.manage().window().getSize().height;
		driver.swipe(width/2, height*3/4, width/2, height/4, 1000);
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击热门推荐省油代步");
		...
		if (findElementById("tv_pop_content").getText().equals("省油代步车")) {
			...
			reports_HomePageTest.log(LogStatus.INFO, "点击省油代步车跳转到的列表页筛选显示不正常");
	...
	public void test_1901_RMTJ_QYYG() {
		reports_HomePageTest.startTest("test_1900_RMTJ_QYYG");
		gotocate(1);
		wait(1);
		int width = driver.manage().window().getSize().width;
		int height = driver.manage().window().getSize().height;
		driver.swipe(width/2, height*3/4, width/2, height/4, 1000);
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击热门推荐精选好车");
		...
		if (findElementById("tv_pop_content").getText().equals("精选好车")) {
			...
			reports_HomePageTest.log(LogStatus.INFO, "点击精选好车跳转到的列表页筛选显示不正常");
	...
	public void test_1601_YCGJS() {
		...
		reports_HomePageTest.log(LogStatus.INFO, "点击首页一成购详情介绍页入口");
		checkTitlebar_Webview("一成购介绍");
		reports_HomePageTest.log(LogStatus.INFO, "点击首页一成购详情介绍页按钮进入一成购介绍页");
	...
	public void test_1601_YCG_XC() {
		reports_HomePageTest.startTest("test_1600_YCG_XC");
		gotocate(1);
		wait(1);
		sliding("up");
		wait(1);
...
//			switchToWebView();	
//		}
//		reports_HomePageTest.log(LogStatus.INFO, "点击一成购介绍页左下角的一成购选车按钮");
...
//			reports_HomePageTest.log(LogStatus.INFO, "点击一成购介绍页左下角的一成购选车按钮，进入一成购列表页。");
//        	System.out.println("点击一成购介绍页左下角的一成购选车按钮，进入一成购列表页。");
//        }else {
//        	reports_HomePageTest.log(LogStatus.ERROR, "点击一成购介绍页左下角的一成购选车按钮，没有进入一成购列表页。");
...
//		}
	...
	public void test_1601_YCGJS_MORE() {
		reports_HomePageTest.startTest("test_1601_YCGJS_MORE");
		gotocate(1);
		wait(1);
		sliding("up");
		wait(1);
...
//			switchToWebView();	
//		}
//		reports_HomePageTest.log(LogStatus.INFO, "点击一成购介绍页底部的查看更多车源按钮");
...
//		if(findElementByName("买车").getAttribute("checked").equals("true")&&
//				findElementByXpath("//android.widget.FrameLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.FrameLayout[1]/android.view.ViewGroup[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.RelativeLayout[3]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.TextView[2]").getText().equals("1")) {
//			reports_HomePageTest.log(LogStatus.INFO, "点击一成购介绍页底部的查看更多车源按钮，进入一成购列表页。");
//        	System.out.println("点击一成购介绍页底部的查看更多车源按钮，进入一成购列表页。");
//        }else {
//        	reports_HomePageTest.log(LogStatus.ERROR, "点击一成购介绍页底部的查看更多车源按钮，没有进入一成购列表页。");
...
//		}
	...
	public void test_1102_RSCYCG_1() {
		reports_HomePageTest.startTest("test_1102_RSCYCG_1");
		gotocate(1);
		wait(1);
		sliding("up");
		wait(1);
...
//		driver.swipe(width/2, height*4/5, width/2, height*1/10, 1000);
		String title = findElementById("tv_rec_yichenggou_title").getText();
		clickElementById("tv_rec_yichenggou_title");
		reports_HomePageTest.log(LogStatus.INFO,"点击首页一成购第一个品牌车系入口");
		if(findElementById("tv_pop_content").getText().equals(title)) {
			...
			reports_HomePageTest.log(LogStatus.ERROR,"点击首页一成购第一个品牌车系"+title+";跳转的不对。");
	...
	public void test_1102_RSCYCG_2() {
		reports_HomePageTest.startTest("test_1102_RSCYCG_2");
		gotocate(1);
		wait(1);
		sliding("up");
		wait(1);
...
//		int height = driver.manage().window().getSize().height;
//		driver.swipe(width/2, height*4/5, width/2, height*1/10, 1000);
		String title = findElementById("tv_rec_yichenggou_right_title").getText();
		clickElementById("tv_rec_yichenggou_right_title");
		reports_HomePageTest.log(LogStatus.INFO,"点击首页一成购第2个品牌车系入口");
		if(findElementById("tv_pop_content").getText().equals(title)) {
			CheckNewListFromHomePage();
			toDetailFromNewList();
			checkTitlebar_Detail();
			...
			reports_HomePageTest.log(LogStatus.ERROR,"点击首页一成购第2个品牌车系"+title+";跳转的不对。");
...
//		reports_HomePageTest.startTest("test_1102_RSCYCG");
//		gotocate(1);
//		wait(1);
////		sliding("up");
////		sleep(1000);
...
//				toDetail(1);
//			}else {
//				reports_HomePageTest.log(LogStatus.ERROR, "点击一成购banner跳转到的列表页显示不正常");
//				failAndMessage("点击一成购banner跳转到的列表页显示不正常");
//			}
//		}else {
//			reports_HomePageTest.log(LogStatus.ERROR,"一成购banner没有正常显示");
...
//	}
	...
	public void test_1601_ZSCK_detail() {
		reports_HomePageTest.startTest("test_1601_ZSCK_detail");
		gotocate(1);
		wait(2);
		sliding("up");
		wait(1);
		...
		reports_HomePageTest.log(LogStatus.INFO, "点击首页真实车况介绍页入口");
...
//			switchToWebView();	
//		}
//		reports_HomePageTest.log(LogStatus.INFO, "点击真实车况介绍页底部的查看更多视频车源按钮");
...
//		if(findElementByName("买车").getAttribute("checked").equals("true")&&
//				findElementByXpath("//android.widget.FrameLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.FrameLayout[1]/android.view.ViewGroup[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.RelativeLayout[3]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.TextView[2]").getText().equals("1")) {
//			reports_HomePageTest.log(LogStatus.INFO, "点击真实车况介绍页底部的查看更多视频车源按钮，进入买车列表页。");
//        	System.out.println("点击真实车况介绍页底部的查看更多视频车源按钮，进入买车列表页。");
//        }else {
//        	reports_HomePageTest.log(LogStatus.ERROR, "点击真实车况介绍页底部的查看更多视频车源按钮，没有进入买车列表页。");
...
//		}
	...
	public void test_1900_ZSCK_video() {
		reports_HomePageTest.startTest("test_1900_ZSCK_video");
		gotocate(1);
		wait(1);
		sliding("up");
		wait(1);
		...
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击真实车况-视频检测");
		...
		if (findElementById("tv_pop_content").getText().equals("视频检测")) {
			...
			reports_HomePageTest.log(LogStatus.INFO, "点击真实车况-视频检测跳转到的列表页筛选显示不正常");
	...
	public void test_1900_ZSCK_SSKC() {
		reports_HomePageTest.startTest("test_1900_ZSCK_SSKC");
		gotocate(1);
		wait(1);
		sliding("up");
		wait(1);
		...
		driver.swipe(width/2, height*3/4, width/2, height*2/4, 1000);
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击真实车况-随时看车");
		...
		if (findElementById("tv_pop_content").getText().equals("随时看车")) {
			...
			reports_HomePageTest.log(LogStatus.INFO, "点击真实车况-随时看车跳转到的列表页筛选显示不正常");
	...
	public void test_1601_CZHC_detail() {
		reports_HomePageTest.startTest("test_1601_CZHC_detail");
		gotocate(1);
		wait(1);
		sliding("up");
		wait(1);
		...
		reports_HomePageTest.log(LogStatus.INFO, "点击首页超值好车介绍页入口");
...
//			switchToWebView();	
//		}
//		reports_HomePageTest.log(LogStatus.INFO, "点击超值好车介绍页底部的查看更多超值车源按钮");
...
//		if(findElementByName("买车").getAttribute("checked").equals("true")&&
//				findElementByXpath("//android.widget.FrameLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.FrameLayout[1]/android.view.ViewGroup[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.RelativeLayout[3]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.TextView[2]").getText().equals("1")) {
//			reports_HomePageTest.log(LogStatus.INFO, "点击超值好车介绍页底部的查看更多超值车源按钮，进入买车列表页。");
//        	System.out.println("点击超值好车介绍页底部的查看更多超值车源按钮，进入买车列表页。");
//        }else {
//        	reports_HomePageTest.log(LogStatus.ERROR, "点击超值好车介绍页底部的查看更多超值车源按钮，没有进入买车列表页。");
...
//		}
	...
	public void test_1900_CZHC_XJBZX() {
		reports_HomePageTest.startTest("test_1900_CZHC_XJBZX");
		gotocate(1);
		wait(1);
		sliding("up");
		wait(1);
		...
		driver.swipe(width/2, height*3/4, width/2, height/4, 1000);
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击超值好车的点击性价比之选");
		clickElementByName("性价比之选");
		wait(3);
		if (findElementById("tv_pop_content").getText().equals("性价比之选")) {
			findElementById("tvCarWholeName").click();
			wait(3);
			reports_HomePageTest.log(LogStatus.INFO, "进入车辆详情页");
			checkTitlebar_Detail();
        	backBTN();
		}else {
			GetScreenshot("test_1900_CZHC_XJBZX");
			reports_HomePageTest.log(LogStatus.INFO, "点击超值好车的性价比之选跳转到的列表页筛选显示不正常");
	...
	public void test_1900_CZHC_CZTH() {
		reports_HomePageTest.startTest("test_1900_CZHC_CZTH");
		gotocate(1);
		wait(1);
		sliding("up");
		wait(1);
		...
		driver.swipe(width/2, height*3/4, width/2, height/4, 1000);
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击超值好车的点击超值特惠");
		clickElementByName("超值特惠");
		wait(3);
		if (findElementById("tv_pop_content").getText().equals("超值特惠")) {
			CheckNewListFromHomePage();
			reports_HomePageTest.log(LogStatus.INFO, "点击超值好车的超值特惠跳转到的列表页筛选显示正常");
			...
			GetScreenshot("test_1900_CZHC_XJBZX");
			reports_HomePageTest.log(LogStatus.ERROR, "点击超值好车的超值特惠跳转到的列表页筛选显示不正常");
	...
	public void test_1601_3TWLY_more() {
		reports_HomePageTest.startTest("test_1601_3TWLY_more");
		gotocate(1);
		wait(1);
		sliding("up");
		wait(1);
		...
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "点击3天无理由介绍页入口");
		if (findElementById("tv_pop_content").getText().equals("三天无理由")) {
			reports_HomePageTest.log(LogStatus.INFO, "点击三天无理由更多按钮，进入新列表页");
			...
			reports_HomePageTest.log(LogStatus.ERROR, "点击三天无理由更多按钮，进入的新列表页异常，请检查");
	...
	public void test_1900_3TWLY_CAR(){
		reports_HomePageTest.startTest("test_1900_3TWLY_1");
		gotocate(1);
		wait(1);
		sliding("up");
		wait(1);
		...
		reports_HomePageTest.log(LogStatus.INFO, "遍历点击3天无理由的品牌");
		System.out.println("遍历点击3天无理由的品牌");
		for(int i=1; i<4; i++) {
			String title = findElementById("model_title0"+i).getText();
			String des = findElementById("model_des0"+i).getText();
			if(des.equals(str[i-1])) {
				reports_HomePageTest.log(LogStatus.INFO, "3天无理由:"+title+"下面的文案是正确的。");
				System.out.println("3天无理由:"+title+"下面的文案是正确的。");
			}else {
				reports_HomePageTest.log(LogStatus.ERROR, "3天无理由:"+title+"下面的文案不正确，实际上显示为："+des);
				failAndMessage("3天无理由:"+title+"下面的文案不正确，为"+des);
			}
			clickElementById("model_title0"+i);
			reports_HomePageTest.log(LogStatus.INFO, "点击"+title);
			System.out.println("点击"+title);
			wait(1);
			if(findElementById("tv_pop_content").getText().equals(title)) { 
					reports_HomePageTest.log(LogStatus.INFO, "点击"+title+"进入的新列表页正常。");
				...
				reports_HomePageTest.log(LogStatus.ERROR, "点击"+title+"进入的新列表页异常，请人工检查。");
	...
	public void test_1500_CNXH() {
		reports_HomePageTest.startTest("test_1500_CNXH");
		gotocate(1);
		wait(2);
		clickElementById("iv_tab_home_default");
		wait(1);
		if(CheckViewVisibilty(By.name("主人，小优还没有为您准备好车源"))&&
				CheckViewVisibilty(By.name("去车市"))) {
			reports_HomePageTest.log(LogStatus.INFO, "猜你喜欢暂无推荐车源。");
			System.out.println("猜你喜欢暂无推荐车源。");
			clickElementByName("去车市");
			if(findElementByName("买车").getAttribute("checked").equals("true")) {
				reports_HomePageTest.log(LogStatus.INFO, "点击猜你喜欢的去车市，进入到买车页。");
				System.out.println("点击猜你喜欢的去车市，进入到买车页。");
			}else {
				reports_HomePageTest.log(LogStatus.INFO, "点击猜你喜欢的去车市，没有进入到买车页，请检查。");
				failAndMessage("点击猜你喜欢的去车市，没有进入到买车页，请检查。");
			}
		}else if(CheckViewVisibilty(By.id("rootLine"))&&         //整体
	...
	public void test_1500_CNXH_XQ() {
		reports_HomePageTest.startTest("test_1500_CNXH_XQ");
		gotocate(1);
		wait(2);
		clickElementById("iv_tab_home_default");
		wait(1);
	...
	public void test_1500_CNXH_MORE() {
		reports_HomePageTest.startTest("test_1500_CNXH_MORE");
		int i = 0;
		gotocate(1);
		wait(1);
		clickElementById("iv_tab_home_default");
		...
		sleep(200);
		reports_HomePageTest.log(LogStatus.INFO, "先检查猜你喜欢是不是有推荐车源。");
		if(CheckViewVisibilty(By.id("lookupmore"))){
			reports_HomePageTest.log(LogStatus.INFO, "点击查看更多车辆");
			clickElementByName("查看更多车源");
			wait(2);
			if(findElementByName("买车").getAttribute("checked").equals("true")){
	        	reports_HomePageTest.log(LogStatus.INFO, "首页，点击底部查看更多车辆按钮，进入买车tab页。");
	        	System.out.println("首页，点击底部查看更多车辆按钮，进入买车tab页。");
	        }else {
	        	GetScreenshot("test_1500_CNXH_MORE");
	        	reports_HomePageTest.log(LogStatus.ERROR, "首页，点击底部查看更多车辆按钮，没有进入买车tab页，请查看。");
	...
	public void test_1501_CNXH() {
		reports_HomePageTest.startTest("test_1501_CNXH");
		gotocate(1);
		sleep(200);
		clickElementById("iv_tab_home_default");
		reports_HomePageTest.log(LogStatus.INFO, "点击首页tab");
		wait(1);
		if (waitForVisible(By.id("title02"), 3).getAttribute("text").equals("猜你喜欢")) {
			reports_HomePageTest.log(LogStatus.INFO, "点击首页tab跳转到猜你喜欢模块");
			System.out.println("点击首页tab跳转到猜你喜欢模块");
			clickElementById("iv_tab_home_up");
			if(CheckViewVisibilty(By.id("vgSearch"))) {
				reports_HomePageTest.log(LogStatus.INFO, "点击回顶部tab跳转到首页顶部");
				System.out.println("点击回顶部tab跳转到首页顶部");
			}else {
				reports_HomePageTest.log(LogStatus.ERROR, "点击回顶部tab没有跳转到首页顶部，请人工检查");
				GetScreenshot("test_1501_CNXH");
				failAndMessage("点击回顶部tab没有跳转到首页顶部，请人工检查");
			}
		}else {
			reports_HomePageTest.log(LogStatus.ERROR, "点击悬浮按钮后跳转位置不正确");
	...
	public void test_1501_CNXH_FFK_UI() {
		reports_HomePageTest.startTest("test_1501_CNXH_FFK_UI");
		gotocate(1);
		sleep(200);
		reports_HomePageTest.log(LogStatus.INFO, "点击首页tab按钮");
		clickElementById("iv_tab_home_default");
		reports_HomePageTest.log(LogStatus.INFO, "点击关闭按钮");
		clickElementById("ivDelete");
		sleep(500);
		if(findElementById("tvReason").getText().equals("选择具体理由")&&
				findElementById("tvSubmit").getText().equals("不感兴趣")) {
			reports_HomePageTest.log(LogStatus.INFO, "无勾选原因的时候，文案显示：不感兴趣。");
			System.out.println("无勾选原因的时候，文案显示：不感兴趣。");
		}else {
			reports_HomePageTest.log(LogStatus.ERROR, "无勾选原因的时候，文案显示的不是不感兴趣，请检查。");
			failAndMessage("无勾选原因的时候，文案显示的不是不感兴趣，请检查。");
		}
		reports_HomePageTest.log(LogStatus.INFO, "勾选车龄偏高时");
		clickElementByName("车龄偏高");
		if(findElementById("tvReason").getText().equals("已选1个理由")&&
				findElementById("tvSubmit").getText().equals("确定")) {
			reports_HomePageTest.log(LogStatus.INFO, "已选1个理由的时候，文案显示：确定。");
			System.out.println("已选1个理由的时候，文案显示：确定。");
		}else {
			reports_HomePageTest.log(LogStatus.ERROR, "已选1个理由的时候，文案显示的不是确定，请检查。");
	...
	public void test_1501_CNXH_FFK_DELETE() {
		reports_HomePageTest.startTest("test_1501_CNXH_FFK_DELETE");
		gotocate(1);
		sleep(200);
		reports_HomePageTest.log(LogStatus.INFO, "点击首页tab按钮");
		clickElementById("iv_tab_home_default");
		String carName1 = findElementById("tvCarWholeName").getText();
		reports_HomePageTest.log(LogStatus.INFO, "点击关闭按钮");
		clickElementById("ivDelete");
		sleep(500);
		reports_HomePageTest.log(LogStatus.INFO, "点击不感兴趣按钮");
		clickElementById("tvSubmit");
		wait(2);
		String carName2 = findElementById("tvCarWholeName").getText();
		if(carName1.equals(carName2)) {
			reports_HomePageTest.log(LogStatus.INFO, "猜你喜欢负反馈删除车辆失败，请检查！");
			failAndMessage("猜你喜欢负反馈删除车辆失败，请检查！");
		}else {
			reports_HomePageTest.log(LogStatus.INFO, "猜你喜欢负反馈删除车辆成功！");
	...
	public void test_1501_CNXH_FFK_DELETE_LIMIT() {
		reports_HomePageTest.startTest("test_1501_CNXH_FFK_DELETE_LIMIT");
		gotocate(1);
		sleep(200);
		int i=0;
		reports_HomePageTest.log(LogStatus.INFO, "点击首页tab按钮");
		clickElementById("iv_tab_home_default");
		reports_HomePageTest.log(LogStatus.INFO, "遍历40次，点击关闭按钮，点击不感兴趣按钮");
		for(i=0; i<40; i++) {
			clickElementById("ivDelete");
			sleep(500);
			clickElementById("tvSubmit");
		...
		if(!CheckViewVisibilty(By.id("rootLine"))&&   //没有猜你喜欢车辆
				CheckViewVisibilty(By.id("tvEmptyMsgTextTop"))&&
				CheckViewVisibilty(By.id("btEmptyMsgButton"))) {
			reports_HomePageTest.log(LogStatus.INFO, "猜你喜欢负反馈，点击删除按钮，上限为40.");
			System.out.println("猜你喜欢负反馈，点击删除按钮，上限为40.");
		}else if(CheckViewVisibilty(By.id("ivDelete"))){
			System.out.println("i = " + i);
			GetScreenshot("test_1501_cnxh_num");
			reports_HomePageTest.log(LogStatus.INFO, "猜你喜欢的车辆数目超过40，请检查。");
	...
	public void test_1100_KF() {
		reports_HomePageTest.startTest("test_1100_KF");
		gotocate(1);
		wait(1);
		clickElementById("iv_tab_home_default");
		reports_HomePageTest.log(LogStatus.INFO, "点击首页tab跳转到猜你喜欢模块");
		if(CheckViewVisibilty(By.id("xuanfuflaw"))) {
			reports_HomePageTest.log(LogStatus.INFO, "猜你喜欢模块有客服悬浮按钮");
			System.out.println("猜你喜欢模块有客服悬浮按钮");
			clickElementById("xuanfuflaw");
			reports_HomePageTest.log(LogStatus.INFO, "点击客服悬浮按钮");
			wait(1);
			checkTitlebar1("优信二手车");
			reports_HomePageTest.log(LogStatus.INFO, "点击客服悬浮按钮进入到聊天页面");
			System.out.println("点击客服悬浮按钮进入到聊天页面");
		}else {
			reports_HomePageTest.log(LogStatus.ERROR, "猜你喜欢模块没有客服悬浮按钮，请检查");
...
//					&&CheckViewVisibilty(By.id("lookupsimilarcar"))
	...
	public void test_1100_WAJC() {
		reports_HomePageTest.startTest("test_1100_WAJC");
		gotocate(1);
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "检测商城热卖文案是否正确");
	...
	public void test_1100_xxCY() {
		reports_HomePageTest.startTest("test_1100_xxCY");
		gotocate(1);
		wait(1);
		reports_HomePageTest.log(LogStatus.INFO, "检测文案包含全部 辆车源");
		String str = findElementById("cartotal").getText();
		...
		if (num == 0) {
			reports_HomePageTest.log(LogStatus.ERROR, "检测文案包含全部 辆车源");
			failAndMessage("全部车源总数有问题，请人工检测");
		}else {
			System.out.println("全部车源显示正确>>>"+num);
			reports_HomePageTest.log(LogStatus.INFO, "全部车源显示正确>>>"+num);
		}
	...
	public void test_1102_RMCH() {
		reports_HomePageTest.startTest("test_1102_RMCH");
		gotocate(1);
		reports_HomePageTest.log(LogStatus.INFO, "开始遍历热门车型");
		String[] str = {"SUV","MPV","三厢轿车","两厢轿车"};
		String[] listStrings = {"SUV","MPV","三厢轿车","两厢轿车"};
		List<WebElement>  price= driver.findElements(By.xpath("//android.widget.FrameLayout[1]/android.widget.FrameLayout[1]"
				...
				+ "/android.widget.FrameLayout[1]/android.support.v7.widget.RecyclerView[1]/android.widget.LinearLayout[4]"
				+ "/android.widget.GridView[1]/android.widget.RelativeLayout"));
		System.out.println("price>>>>"+price.size());
		if (price.size()==4) {
			for (int i = 1; i <= 4; i++) {
				String textString =findElementByXpath("//android.widget.FrameLayout[1]/android.widget.FrameLayout[1]"
						+ "/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]"
						+ "/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.FrameLayout[1]"
						+ "/android.widget.RelativeLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]"
						+ "/android.widget.FrameLayout[1]/android.support.v7.widget.RecyclerView[1]/android.widget.LinearLayout[4]"
						+ "/android.widget.GridView[1]/android.widget.RelativeLayout["+i+"]/android.widget.TextView").getAttribute("text");
				System.out.println("textString>>>"+textString);
				if (textString.equals(str[i-1])) {
					System.out.println("文案检索正确");
				}else {
					failAndMessage("文案检索失败");
				}
			}
		}else {
			failAndMessage("文案展示个数有问题，请手动检查");
		}
	}
